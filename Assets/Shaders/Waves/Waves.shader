...
Shader "Waves"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float temp_output_25_0_g2 = WaveLenght34;
			float Speed43 = _Speed;
			float w38_g2 = sqrt( ( ( 6.28318548202515 / temp_output_25_0_g2 ) * 9.8 ) );
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float3 temp_output_26_0_g2 = _Dir1;
			float dotResult18_g2 = dot( ase_worldPos , temp_output_26_0_g2 );
			float temp_output_21_0_g2 = ( ( ( ( 2.0 / temp_output_25_0_g2 ) * Speed43 ) * _Time.y ) + ( w38_g2 * dotResult18_g2 ) );
			float temp_output_23_0_g2 = cos( temp_output_21_0_g2 );
			float3 break33_g2 = temp_output_26_0_g2;
			float Steepness40 = _Steepness;
			float Amplitude32 = _Amplitude;
			float temp_output_28_0_g2 = Amplitude32;
			float NumOfWaves41 = _NumOfWaves;
			float temp_output_43_0_g2 = ( ( Steepness40 / ( w38_g2 * temp_output_28_0_g2 * NumOfWaves41 ) ) * temp_output_28_0_g2 );
			float3 appendResult24_g2 = (float3(( temp_output_23_0_g2 * break33_g2.x * temp_output_43_0_g2 ) , ( sin( temp_output_21_0_g2 ) * temp_output_28_0_g2 ) , ( temp_output_23_0_g2 * break33_g2.z * temp_output_43_0_g2 )));
			float temp_output_25_0_g8 = WaveLenght34;
			...
			float temp_output_21_0_g8 = ( ( ( ( 2.0 / temp_output_25_0_g8 ) * Speed43 ) * _Time.y ) + ( w38_g8 * dotResult18_g8 ) );
			float temp_output_23_0_g8 = cos( temp_output_21_0_g8 );
			float3 break33_g8 = temp_output_26_0_g8;
			float temp_output_28_0_g8 = Amplitude32;
			float temp_output_43_0_g8 = ( ( Steepness40 / ( w38_g8 * temp_output_28_0_g8 * NumOfWaves41 ) ) * temp_output_28_0_g8 );
			...
			float temp_output_25_0_g7 = ( WaveLenght34 * 3.0 );
			float w38_g7 = sqrt( ( ( 6.28318548202515 / temp_output_25_0_g7 ) * 9.8 ) );
			float3 temp_output_26_0_g7 = _Vector1;
			float dotResult18_g7 = dot( ase_worldPos , temp_output_26_0_g7 );
			float temp_output_21_0_g7 = ( ( ( ( 2.0 / temp_output_25_0_g7 ) * Speed43 ) * _Time.y ) + ( w38_g7 * dotResult18_g7 ) );
			float temp_output_23_0_g7 = cos( temp_output_21_0_g7 );
			float3 break33_g7 = temp_output_26_0_g7;
			float temp_output_28_0_g7 = Amplitude32;
			float temp_output_43_0_g7 = ( ( Steepness40 / ( w38_g7 * temp_output_28_0_g7 * NumOfWaves41 ) ) * temp_output_28_0_g7 );
			...
			float temp_output_25_0_g5 = ( WaveLenght34 * 0.5 );
			float w38_g5 = sqrt( ( ( 6.28318548202515 / temp_output_25_0_g5 ) * 9.8 ) );
			float3 temp_output_26_0_g5 = _Vector0;
			float dotResult18_g5 = dot( ase_worldPos , temp_output_26_0_g5 );
			float temp_output_21_0_g5 = ( ( ( ( 2.0 / temp_output_25_0_g5 ) * Speed43 ) * _Time.y ) + ( w38_g5 * dotResult18_g5 ) );
			float temp_output_23_0_g5 = cos( temp_output_21_0_g5 );
			float3 break33_g5 = temp_output_26_0_g5;
			float temp_output_28_0_g5 = ( Amplitude32 * 0.5 );
			float temp_output_43_0_g5 = ( ( Steepness40 / ( w38_g5 * temp_output_28_0_g5 * NumOfWaves41 ) ) * temp_output_28_0_g5 );
			float3 appendResult24_g5 = (float3(( temp_output_23_0_g5 * break33_g5.x * temp_output_43_0_g5 ) , ( sin( temp_output_21_0_g5 ) * temp_output_28_0_g5 ) , ( temp_output_23_0_g5 * break33_g5.z * temp_output_43_0_g5 )));
			float3 GerrstnerWaves101 = ( appendResult24_g2 + appendResult24_g8 + appendResult24_g7 + appendResult24_g5 );
...
/*ASEBEGIN
Version=18900
219;367;833;307;2823.202;-637.9776;2.034554;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-5542.13,259.1118;Inherit;False;Property;_SmallNormalTiling;SmallNormalTiling;23;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-5489.13,-78.88832;Inherit;False;Property;_BigNormalTiling;BigNormalTiling;22;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;19;-5266.292,-77.52638;Inherit;False;Property;_BigNormalSpeed;BigNormalSpeed;36;0;Create;True;0;0;0;False;0;False;0,0;-0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;20;-5296.404,260.5078;Inherit;False;Property;_SmallNormalSpeed;SmallNormalSpeed;26;0;Create;True;0;0;0;False;0;False;0,0;-0.1,0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;26;-4988.983,217.9004;Inherit;True;Property;_SmallNormalTex;SmallNormalTex;24;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;c2b58cf0fa9a6154388ba33da184a1b8;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-4850.67,-1681.97;Inherit;False;Property;_WaveLenght;WaveLenght;12;0;Create;True;0;0;0;False;0;False;0;150;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-5042.989,-1677.327;Inherit;False;Property;_Amplitude;Amplitude;9;0;Create;True;0;0;0;False;0;False;0;0.18;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-5545.913,-1684.602;Inherit;False;Property;_Steepness;Steepness;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-4650.896,-1681.647;Inherit;False;Property;_Speed;Speed;13;0;Create;True;0;0;0;False;0;False;0;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-5267.447,-1682.159;Inherit;False;Property;_NumOfWaves;Num Of Waves;6;0;Create;True;0;0;0;False;0;False;0;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;65;-2620.977,-609.6941;Inherit;False;Property;_Dir2;Dir2;21;0;Create;True;0;0;0;False;0;False;0,0,0;0.2,0,-1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;74;-2629.958,-72.92491;Inherit;False;Property;_Vector1;Vector 1;35;0;Create;True;0;0;0;False;0;False;0,0,0;0.3,0,-1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;48;-5303.452,1019.754;Inherit;False;Property;_OpacityDepthRange;OpacityDepthRange;25;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;62;-2908.206,-833.8389;Inherit;False;41;NumOfWaves;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-5501.112,-888.7947;Inherit;False;Property;_HeightOffset;HeightOffset;10;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;51;-2897.532,-682.1849;Inherit;False;34;WaveLenght;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;63;-1772.083,146.3687;Inherit;False;Property;_Vector0;Vector 0;37;0;Create;True;0;0;0;False;0;False;0,0,0;0.3,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;72;-1837.293,-938.0277;Inherit;False;Property;_Dir1;Dir1;14;0;Create;True;0;0;0;False;0;False;0,0,0;0.1,0,-1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-5093.521,-883.1033;Inherit;False;Property;_HeightDiference;HeightDiference;11;0;Create;True;0;0;0;False;0;False;1;3.51;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;79;-1833.078,-1123.906;Inherit;False;Inner Waves Function;-1;;2;7d7672e142756fd488f82876d9ed566a;0;6;36;FLOAT;0;False;37;FLOAT;0;False;28;FLOAT;0;False;25;FLOAT;0;False;26;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-5120.965,855.5513;Inherit;False;Property;_HeightDepthRange;HeightDepthRange;28;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;82;-5091.404,1021.691;Inherit;False;Property;_OpacityDepthFallOff;OpacityDepthFallOff;27;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;85;-2627.864,-257.1918;Inherit;False;Inner Waves Function;-1;;7;7d7672e142756fd488f82876d9ed566a;0;6;36;FLOAT;0;False;37;FLOAT;0;False;28;FLOAT;0;False;25;FLOAT;0;False;26;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;81;-1775.525,-37.82488;Inherit;False;Inner Waves Function;-1;;5;7d7672e142756fd488f82876d9ed566a;0;6;36;FLOAT;0;False;37;FLOAT;0;False;28;FLOAT;0;False;25;FLOAT;0;False;26;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;84;-2624.357,-799.3688;Inherit;False;Inner Waves Function;-1;;8;7d7672e142756fd488f82876d9ed566a;0;6;36;FLOAT;0;False;37;FLOAT;0;False;28;FLOAT;0;False;25;FLOAT;0;False;26;FLOAT3;0,0,0;False;27;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-4893.288,-475.6191;Inherit;False;Property;_FresnelScale;FresnelScale;33;0;Create;True;0;0;0;False;0;False;0;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;90;-4897.422,-403.1706;Inherit;False;Property;_FresnelPower;FresnelPower;34;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-4905.954,852.5851;Inherit;False;Property;_HeightDepthOffset;HeightDepthOffset;30;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-4840.058,1023.03;Inherit;False;Property;_OpacityMultiplier;OpacityMultiplier;29;0;Create;True;0;0;0;False;0;False;0;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;103;-5533.413,-1373.3;Inherit;False;Property;_HighColor;HighColor;7;0;Create;True;0;0;0;False;0;False;0.2295745,0.4276968,0.6320754,0;0.1611338,0.4811321,0.2072136,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;102;-5532.673,-1200.41;Inherit;False;Property;_LowColor;LowColor;8;0;Create;True;0;0;0;False;0;False;0.4198113,0.7986241,1,0;0.2069241,0.5849056,0.5570618,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;109;-4886.038,-831.6484;Inherit;True;Property;_TextureSample0;Texture Sample 0;32;0;Create;True;0;0;0;False;0;False;-1;None;4c75884fee9e9144babe5634026cb9e2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;106;-5555.585,1450.951;Inherit;False;Property;_FakeNormalIntensity;FakeNormalIntensity;16;0;Create;True;0;0;0;False;0;False;0;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-5344.993,49.21016;Inherit;False;Property;_BigNormalIntensity;BigNormalIntensity;19;0;Create;True;0;0;0;False;0;False;0;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-5363.113,384.7024;Inherit;False;Property;_SmalNormalIntensity;SmalNormalIntensity;18;0;Create;True;0;0;0;False;0;False;0;0.1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;125;-2418.791,934.1137;Inherit;False;Property;_Metallic;Metallic;31;0;Create;True;0;0;0;False;0;False;0;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;126;-2415.191,1011.445;Inherit;False;Property;_Smoothness;Smoothness;15;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;128;-2331.801,783.0014;Inherit;False;120;HeightColor;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=532CD66BDA673B06A7123E02EB44E3B400CB67F8