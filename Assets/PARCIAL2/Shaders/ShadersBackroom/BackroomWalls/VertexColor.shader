...
Shader "VertexColor"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord18 = i.uv_texcoord * float2( 2,2 ) + float2( 0,0.52 );
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;18;-1140.858,-740.786;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;2,2;False;1;FLOAT2;0,0.52;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5EBF691E9560459471DB7331E2AAE3F8A7AA7E00